...
public class RegisterActivity extends Activity implements View.OnClickListener,
    ...
    protected EditText nameEditText, emailEditText, passwordEditText, schoolEditText, answerEditText;
...
//                        String userId = accessToken.getUserId();
    ...
    private void registerButton() {
        ...
        if (isEdit) {
            if (name.isEmpty() || email.isEmpty() || password.isEmpty() || school.isEmpty() || answer.isEmpty() || securityQuestions.getSelectedItem() == null) {
                makeToast("Please enter required fields");
                return;
            }
            userView = userToEdit.getUserView();
        } else {
            if (name.isEmpty() || email.isEmpty() || password.isEmpty() || school.isEmpty() || answer.isEmpty() || registerUserType.getSelectedItem() == null || securityQuestions.getSelectedItem() == null) {
                makeToast("Please enter required fields");
                return;
            }
