...
import com.attendanceapp.activities.ShowEventUsersActivity;
...
public class EventExpandableListAdapter extends BaseExpandableListAdapter {
    ...
    public EventExpandableListAdapter(Activity context, Event teacherClass) {
    ...
    public View getChildView(int groupPosition, int childPosition, boolean isLastChild, View convertView, ViewGroup parent) {
        ...
        if(context instanceof ShowEventUsersActivity) {
            holder.headerEmail.setText("Attendee Email");
        ...
        holder.editStudentEmail.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                context.startActivityForResult(updateStudent, ShowEventUsersActivity.REQUEST_UPDATE_STUDENT);
            }
        });
