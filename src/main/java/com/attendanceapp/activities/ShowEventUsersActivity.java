...
import com.attendanceapp.adapters.EventExpandableListAdapter;
...
public class ShowEventUsersActivity extends Activity implements View.OnClickListener {
    ...
    private EventExpandableListAdapter userExpandableListAdapter;
    private Event classEventCompany;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        userUtils = new UserUtils(ShowEventUsersActivity.this);
    ...
    private void setAdapter() {
        userExpandableListAdapter = new EventExpandableListAdapter(ShowEventUsersActivity.this, classEventCompany);
    ...
    public void onClick(View v) {
        switch (v.getId()) {
            ...
            case R.id.addStudentButton:
                ...
                Intent addStudentIntent = new Intent(ShowEventUsersActivity.this, InviteUser.class);
    ...
    private void makeToast(String message) {
        Toast.makeText(ShowEventUsersActivity.this, message, Toast.LENGTH_LONG).show();
    }
        ...
        new AsyncTask<Void, Void, String>() {
            ...
            protected void onPostExecute(String result) {
                if (result != null) {
                    ...
                    List<Event> teacherClasses = DataUtils.getEventArrayListFromJsonString(result);
                    ...
                    for (Event aClass : teacherClasses) {
