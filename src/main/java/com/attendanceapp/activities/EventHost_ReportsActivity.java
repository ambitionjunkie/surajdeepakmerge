...
public class EventHost_ReportsActivity extends Activity implements OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        userUtils = new UserUtils(EventHost_ReportsActivity.this);
        teacher = userUtils.getUserFromSharedPrefs();

            teacherClass = teacher.getEventArrayList().get(intent.getIntExtra(EXTRA_CLASS_INDEX, 0));
    ...
    private void calenderButton() {
        ...
        AlertDialog.Builder builder = new AlertDialog.Builder(EventHost_ReportsActivity.this);
    ...
    private void loadCustomReportData(final String yyyymmdd) {
        ...
        new AsyncTask<Void, Void, String>() {
            ...
            ProgressDialog dialog = new ProgressDialog(EventHost_ReportsActivity.this);
            ...
            protected String doInBackground(Void... params) {
                ...
                try {
                    return new WebUtils().post(AppConstants.URL_EVENTHOST_CUSTOM_REPORT, hm);
                } catch (IOException e) {
                    e.printStackTrace();
                    return null;
                }
...
//                hm.put("user_id", classEventCompany.getTeacherId());
                ...
                try {
                    return new WebUtils().post(AppConstants.URL_EVENTHOST_EXPORT_REPORT, hm);
                } catch (IOException e) {
                    e.printStackTrace();
                    return null;
                }
            ...
            protected void onPostExecute(String result) {
                ...
                if (result != null) {
                    try {
                        ...
                        new AlertDialog.Builder(EventHost_ReportsActivity.this)
...
//            fileName = Environment.getExternalStorageDirectory().toString() + "/Notify/" + System.currentTimeMillis() + ".csv";
            ...
            if (!notifyDir.exists() && !notifyDir.isDirectory()) {
                ...
                if (!created) {
                    Toast.makeText(EventHost_ReportsActivity.this, "Unable to create directory to new file", Toast.LENGTH_LONG).show();
                    return;
                }
            }
//            fileName = Environment.getDataDirectory().toString() + "/Notify/" + System.currentTimeMillis() + ".csv";
            ...
            if (!fileToSave.exists()) {
                ...
                if (!created) {
                    Toast.makeText(EventHost_ReportsActivity.this, "Unable to create new file", Toast.LENGTH_LONG).show();
                }
            }
        }
        ...
        protected void onPostExecute(String file_url) {
            ...
            pDialog.dismiss();
            if (fileToSave.exists()) {
                Toast.makeText(EventHost_ReportsActivity.this, "Saved successfully!", Toast.LENGTH_LONG).show();
            } else {
                Toast.makeText(EventHost_ReportsActivity.this, "Error in saving file!", Toast.LENGTH_LONG).show();
            }
        }
    ...
    private void makeToast(String title) {
        Toast.makeText(EventHost_ReportsActivity.this, title, Toast.LENGTH_LONG).show();
    }
