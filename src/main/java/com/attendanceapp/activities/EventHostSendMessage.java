...
public class EventHostSendMessage extends Activity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        sharedPreferences = AndroidUtils.getCommonSharedPrefs(EventHostSendMessage.this);
        ...
        teacherClass = userUtils.getUserFromSharedPrefs().getEventArrayList().get(index);
    ...
    private void setAdapter() {
        listAdapter = new ListAdapter(EventHostSendMessage.this, classMessageArrayList);
    ...
    private void makeToast(String title) {
        Toast.makeText(EventHostSendMessage.this, title, Toast.LENGTH_LONG).show();
    }
