 ...
 */
public class Manager_ReportsActivity extends Activity implements View.OnClickListener {
    ...
    User teacher;
    ClassEventCompany teacherClass;
    //Event companyClass;
    UserUtils userUtils;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        userUtils = new UserUtils(Manager_ReportsActivity.this);
        teacher = userUtils.getUserFromSharedPrefs();

        teacherClass = teacher.getClassEventCompanyArrayList().get(intent.getIntExtra(EXTRA_CLASS_INDEX, 0));
    ...
    private void calenderButton() {
        ...
        AlertDialog.Builder builder = new AlertDialog.Builder(Manager_ReportsActivity.this);
    ...
    private void loadCustomReportData(final String yyyymmdd) {
        ...
        new AsyncTask<Void, Void, String>() {
            ...
            ProgressDialog dialog = new ProgressDialog(Manager_ReportsActivity.this);
            ...
            protected void onPostExecute(String result) {
                ...
                if (result != null) {
                    try {
                        ...
                        new AlertDialog.Builder(Manager_ReportsActivity.this)
...
//            fileName = Environment.getExternalStorageDirectory().toString() + "/Notify/" + System.currentTimeMillis() + ".csv";
            ...
            if (!notifyDir.exists() && !notifyDir.isDirectory()) {
                ...
                if (!created) {
                    Toast.makeText(Manager_ReportsActivity.this, "Unable to create directory to new file", Toast.LENGTH_LONG).show();
                    return;
                }
            }
//            fileName = Environment.getDataDirectory().toString() + "/Notify/" + System.currentTimeMillis() + ".csv";
            ...
            if (!fileToSave.exists()) {
                ...
                if (!created) {
                    Toast.makeText(Manager_ReportsActivity.this, "Unable to create new file", Toast.LENGTH_LONG).show();
                }
            }
        }
        ...
        protected void onPostExecute(String file_url) {
            ...
            pDialog.dismiss();
            if (fileToSave.exists()) {
                Toast.makeText(Manager_ReportsActivity.this, "Saved successfully!", Toast.LENGTH_LONG).show();
            } else {
                Toast.makeText(Manager_ReportsActivity.this, "Error in saving file!", Toast.LENGTH_LONG).show();
            }
        }
    ...
    private void makeToast(String title) {
        Toast.makeText(Manager_ReportsActivity.this, title, Toast.LENGTH_LONG).show();
    }
