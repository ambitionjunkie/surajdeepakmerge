...
public class EventHost_AttendanceTakenActivity extends Activity implements View.OnClickListener {
    ...
    protected Event classEventCompany;
    UserUtils userUtils;
    boolean val=false;
    ...
    private void showAbsentList() {
        listAdapter = new ListAdapter(EventHost_AttendanceTakenActivity.this, absentStudentsList);
    ...
    private void showPresentList() {
        listAdapter = new ListAdapter(EventHost_AttendanceTakenActivity.this, presentStudentsList);
        listView.setAdapter(listAdapter);
    ...
    public void saveButton(View view) {
        ...
        new AsyncTask<Void, Void, Void>() {
            ...
            protected void onPostExecute(Void aVoid) {
                ...
                Toast.makeText(EventHost_AttendanceTakenActivity.this, message, Toast.LENGTH_LONG).show();
                if (finish) {
                    finish();
                }
            }
